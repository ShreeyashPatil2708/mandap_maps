...
# App-level secrets: Groq API key + constructed Postgres URL for the chatbot.
# Created once with placeholder values; update via CLI after apply:
#   aws secretsmanager put-secret-value \
#     --secret-id mandapmaps-prod/app \
#     --secret-string '{"groq_api_key":"<real-key>","postgres_url":"postgresql://..."}'
